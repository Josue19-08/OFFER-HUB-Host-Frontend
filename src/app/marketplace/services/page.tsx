...
export default function BrowseServicesPage(): React.JSX.Element {
  ...
  // Fetch services when filters or search changes
  useEffect(() => {
    async function fetchServices() {
      ...
      try {
        const response = await getPublicServices({
          ...
          minPrice: filters.minBudget > 0 ? filters.minBudget : undefined,
          maxPrice: filters.maxBudget < 10000 ? filters.maxBudget : undefined,
