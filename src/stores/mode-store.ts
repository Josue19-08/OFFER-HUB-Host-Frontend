...
export const getNavigationItems = (mode: UserMode) => {
  const commonItems = [
    {
      href: "/app/dashboard",
      label: "Dashboard",
  ...
  if (mode === "freelancer") {
    return [commonItems[0], ...freelancerItems, commonItems[1], commonItems[2]];
  } else {
    return [commonItems[0], ...clientItems, commonItems[1], commonItems[2]];
  }
};
